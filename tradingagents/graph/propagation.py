...
class Propagator:
    ...
    def create_initial_state(
        ...
        decision_horizon: str = "next_trading_day",
        horizon_instruction: str = "",
    ) -> Dict[str, Any]:
        ...
        horizon_text = horizon_instruction or "本次信号是日频信号，请判断下一交易日的可执行操作。"
        analysis_request = (
            f"请对股票 {company_name} 进行全面分析，交易日期为 {trade_date}。\n"
            f"决策周期约束：{horizon_text}"
        )
        ...
        return {
            ...
            "horizon_instruction": horizon_text,
