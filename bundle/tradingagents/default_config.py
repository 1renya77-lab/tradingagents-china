...
DEFAULT_CONFIG = {
    ...
    "results_dir": os.getenv("TRADINGAGENTS_RESULTS_DIR", "./outputs/signals"),
    ...
    "max_recur_limit": 100,
    "run_name": None,
    # Markdown decision log memory. Path defaults to project_dir/outputs/memory
    # inside TradingAgentsGraph so moved bundles keep memory local to the project.
    "memory_log_enabled": os.getenv("TRADINGAGENTS_MEMORY_LOG_ENABLED", "true").lower() == "true",
    "memory_log_max_entries": int(os.getenv("TRADINGAGENTS_MEMORY_LOG_MAX_ENTRIES", "50")),
