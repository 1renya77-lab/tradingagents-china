...
class AgentState(MessagesState):
    ...
    signal_frequency: Annotated[str, "Signal generation frequency: daily or weekly"]
    decision_horizon: Annotated[str, "Trading decision horizon"]
    horizon_instruction: Annotated[str, "Human-readable horizon instruction for agents"]
