...
def build_verified_market_snapshot(
    ...
    if upper_symbol.endswith((".SH", ".SZ")) or upper_symbol.startswith(("SH", "SZ")):
        from tradingagents.dataflows.china_akshare import get_china_verified_market_snapshot
        return get_china_verified_market_snapshot(symbol, curr_date, look_back_days)
